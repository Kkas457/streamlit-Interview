...
def whisper_stt(audio_path: Path, prompt_text: str = None):
    try:
    ...
    if st.session_state.processing_started:
        ...
        if not ffmpeg_available():
            ...
            for i, seg in enumerate(st.session_state.timestamps):
                ...
                if ok and ok.exists():
                    question_for_prompt = QUESTIONS[q_idx]
                    transcription_text = whisper_stt(ok, prompt_text=question_for_prompt)
